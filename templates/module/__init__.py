...
#
"""
Plinth module to configure $app.
"""
...
def is_running():
    ...
    return action_utils.service_is_running('$app')


def is_enabled():
    """Return whether the module is enabled."""
    return (action_utils.service_is_enabled('$app') and
            action_utils.webserver_is_enabled('$app-plinth'))


def enable():
    """Enable the module."""
    actions.superuser_run('$app', ['enable'])
    add_shortcut()
